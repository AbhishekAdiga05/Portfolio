      ...
      <div className="max-w-7xl mx-auto">
        <FadeUp>
          <div className="mb-14 max-w-3xl">
            ...
            <h2 className="mb-4" style={{ fontSize: "clamp(2.25rem, 4vw, 3rem)", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Certifications</h2>
          ...
          {certifications.map((cert, i) => (
            <FadeUp key={`${cert.name}-${cert.issuer}`} delay={i * 0.05}>
              ...
              >
                ...
                <p className="font-semibold leading-snug mb-3" style={{ color: "var(--foreground)", fontSize: "0.9375rem", letterSpacing: "-0.01em" }}>{cert.name}</p>
                <p className="text-sm mb-4" style={{ color: "var(--foreground-secondary)" }}>{cert.issuer}</p>
